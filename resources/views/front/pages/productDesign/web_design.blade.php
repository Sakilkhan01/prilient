...
/ Responsive Website Design / Usability Testing</p>
                  ...
                  <div class="col-lg-6 col-12 mt-4">
                        <img src="{{ asset('assets/images/banner/globe.png') }}">
                  </div>
            </div>
         </div>
      </div>
...
<section class="service-content-body">
    <div class="container pb-5">
      ...
      <div class="col-lg-5 col-12 text-center mt-5">
            <img src="{{ asset('assets/services/business.svg') }}">
      </div>
      <div class="col-lg-7 col-12 mt-5">
          <div class="comman-service-heading">
             <img src="{{ asset('assets/services/DesignYourBusinessWebsiteinTheMostAppealingWay.png') }}">
                        ...
                        <div class="card-with-icon text-center card-service-equal h-100  p-0">
                              <div class="header_card bg-header-card-pink">
                                ...
                                <div class="header_icon bg-header-card-pink">
                                  <img src="{{ asset('assets/services/web_design-vactor-1.png') }}">
                                </div>
                                </div>
                        ...
                        <div class="card-with-icon text-center card-service-equal h-100  p-0">
                              <div class="header_card bg-header-card-blue">
                                ...
                                <div class="header_icon bg-header-card-blue">
                                  <img src="{{ asset('assets/services/Layer_1.png') }}">
                                </div>
                                </div>
                  ...
                  <div class="col-lg-4 col-12 mt-5">
                        <div class="card-with-icon text-center card-service-equal h-100  p-0">
                              <div class="header_card bg-header-card-pink">
                                <div class="img-liner">
                                <div class="header_icon bg-header-card-pink">
                                  <img src="{{ asset('assets/services/Layer_2.png') }}">
                                </div>
                                </div>
                  ...
                  <div class="col-lg-4 col-12 mt-5">
                        <div class="card-with-icon text-center card-service-equal h-100  p-0">
                              <div class="header_card bg-header-card-pink">
                                <div class="img-liner">
                                <div class="header_icon bg-header-card-pink">
                                  <img src="{{ asset('assets/services/Layer_3.png') }}">
                                </div>
                                </div>
                                <h5>Final Testing</h5>
                              </div>
                  ...
                  <div class="col-lg-4 col-12 mt-5">
                        <div class="card-with-icon text-center card-service-equal h-100  p-0">
                              <div class="header_card bg-header-card-blue">
                                <div class="img-liner">
                                <div class="header_icon bg-header-card-blue">
                                  <img src="{{ asset('assets/services/Layer_4.png') }}">
                                </div>
                                </div>
                                <h5>Launch</h5>
                              </div>
                      ...
                      <span class="bg-service-text-heading">Services We Offered in </span><span class="textPrim txt-heading">Web Designing</span>
                                    ...
                                    <div class="services_card bg_card_yellow bg-hover-white p-0">
                                      ...
                                      <div class="custom-w18 p-3">
                                        <div class="image-bg-crd bg-prim">
                                          <img src="{{ asset('assets/services/Group58.png') }}">
                                        </div>
                                      </div>
                                    ...
                                    <div class="services_card bg_card_yellow bg-hover-white p-0">
                                      ...
                                      <div class="custom-w18 p-3">
                                        <div class="image-bg-crd bg-dng">
                                          <img src="{{ asset('assets/services/Group59.png') }}">
                                        </div>
                                      </div>
                                        <div class="custom-w76 p-3">
                              ...
                              <div class="col-lg-12 col-12 mt-5">
                                    <div class="services_card bg_card_yellow bg-hover-white p-0">
                                      ...
                                      <div class="custom-w18 p-3">
                                        <div class="image-bg-crd bg-prim">
                                          <img src="{{ asset('assets/services/Group60.png') }}">
                                        </div>
                                      </div>
                                        <div class="custom-w76 p-3">
                              ...
                              <div class="col-lg-12 col-12 mt-5">
                                    <div class="services_card bg_card_yellow bg-hover-white p-0">
                                      ...
                                      <div class="custom-w18 p-3">
                                        <div class="image-bg-crd bg-dng">
                                          <img src="{{ asset('assets/services/Group61.png') }}">
                                        </div>
                                      </div>
                                        <div class="custom-w76 p-3">
            ...
            <div class="col-lg-11 col-12 ml-auto mr-auto">
                        ...
                        <div class="bottom_card_product">
                              <div class="row">
                                   <div class="col-lg-2 col-12 d-flex justify-content-center align-items-center">
                                         <img src="{{asset('assets/services/Group65.png')}}">
                                   </div> 
                  ...
                  <div class="col-12 col-lg-12 mt-4">
                        <div class="bottom_card_product">
                              <div class="row">
                                   <div class="col-lg-2 col-12 d-flex justify-content-center align-items-center">
                                         <img src="{{asset('assets/services/Group66.png')}}">
                                   </div> 
                                   <div class="col-lg-10 col-12 borderLeft">
                  ...
                  <div class="col-12 col-lg-12 mt-4">
                        <div class="bottom_card_product">
                              <div class="row">
                                   <div class="col-lg-2 col-12 d-flex justify-content-center align-items-center">
                                         <img src="{{asset('assets/services/Group67.png')}}">
                                   </div> 
                                   <div class="col-lg-10 col-12 borderLeft">
                  ...
                  <div class="col-12 col-lg-12 mt-4">
                        <div class="bottom_card_product">
                              <div class="row">
                                   <div class="col-lg-2 col-12 d-flex justify-content-center align-items-center">
                                         <img src="{{asset('assets/services/Group68.png')}}">
                                   </div> 
                                   <div class="col-lg-10 col-12 borderLeft">
                  ...
                  <div class="col-12 col-lg-12 mt-4">
                        <div class="bottom_card_product">
                              <div class="row">
                                   <div class="col-lg-2 col-12 d-flex justify-content-center align-items-center">
                                         <img src="{{asset('assets/services/Group69.png')}}">
                                   </div> 
                                   <div class="col-lg-10 col-12 borderLeft">
