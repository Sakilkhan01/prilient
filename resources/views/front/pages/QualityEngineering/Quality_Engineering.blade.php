    ...
    <div class="container pb-5">
      <div class="row">
       <div class="col-lg-5 col-12 text-center mt-5">
            <img src="{{ asset('public/assets/services/Group174.svg') }}">
      </div>
                  ...
                  <div class="col-lg-9 col-12 text-center">
                        ...
                        <div class="row justify-content-center">
                              <div class="col-lg-5 col-12 mt-5">
                                    <div class="services_card bg_card_yellow bg-hover-white text-center card-service-equal h-100">
                                         <div class="iconCircle d-flex">
                                           <img src="{{ asset('public/assets/services/Group175.svg') }}">
                                         </div>
                                         <div>
                              ...
                              <div class="col-lg-5 col-12 mt-5  offset-lg-1">
                                    <div class="services_card bg_card_yellow bg-hover-white text-center card-service-equal h-100">
                                         <div class="iconCircle d-flex">
                                           <img src="{{ asset('public/assets/services/Group176.svg') }}">
                                         </div>
                                         <div>
                                           <h5>ERP Testing</h5>
                                          <p>
                              ...
                              <div class="col-lg-5 col-12 mt-5">
                                    <div class="services_card bg_card_yellow bg-hover-white text-center card-service-equal h-100">
                                         <div class="iconCircle">
                                           <img src="{{ asset('public/assets/services/Group177.svg') }}">
                                         </div>
                                         <div>
                                           <h5>Game Testing</h5>
                                          <p>
                              ...
                              <div class="col-lg-5 col-12 mt-5 offset-lg-1">
                                    <div class="services_card bg_card_yellow bg-hover-white text-center card-service-equal h-100">
                                         <div class="iconCircle">
                                           <img src="{{ asset('public/assets/services/Group179.svg') }}">
                                         </div>
                                         <div>
                         ...
                         <div class="row justify-content-center">
                              <div class="col-lg-5 col-12 mt-5">
                                    <div class="services_card bg_card_yellow bg-hover-white text-center card-service-equal h-100">
                                         <div class="iconCircle">
                                           <img src="{{ asset('public/assets/services/Group180.svg') }}">
                                         </div>
                                         <div>
                              ...
                              <div class="col-lg-5 col-12 mt-5 offset-lg-1">
                                    <div class="services_card bg_card_yellow bg-hover-white text-center card-service-equal h-100">
                                         <div class="iconCircle">
                                           <img src="{{ asset('public/assets/services/Group178.svg') }}">
                                         </div>
                                         <div>
                         ...
                         <div class="row justify-content-center">
                              <div class="col-lg-5 col-12 mt-5">
                                    <div class="services_card bg_card_yellow bg-hover-white text-center card-service-equal h-100">
                                         <div class="iconCircle">
                                           <img src="{{ asset('public/assets/services/Group181.svg') }}">
                                         </div>
                                         <div>
                              ...
                              <div class="col-lg-5 col-12 mt-5 offset-lg-1">
                                    <div class="services_card bg_card_yellow bg-hover-white text-center card-service-equal h-100">
                                         <div class="iconCircle">
                                           <img src="{{ asset('public/assets/services/Group182.svg') }}">
                                         </div>
                                         <div>
                        ...
                        <div class="row justify-content-center">
                              <div class="col-lg-5 col-12 mt-5">
                                    <div class="services_card bg_card_yellow bg-hover-white text-center card-service-equal h-100">
                                         <div class="iconCircle">
                                           <img src="{{ asset('public/assets/services/Group183.svg') }}">
                                         </div>
                                         <div>
                              ...
                              <div class="col-lg-5 col-12 mt-5 offset-lg-1">
                                    <div class="services_card bg_card_yellow bg-hover-white text-center card-service-equal h-100">
                                         <div class="iconCircle">
                                           <img src="{{ asset('public/assets/services/Group184.svg') }}">
                                         </div>
                                         <div>
                        ...
                        <div class="card-with-icon text-center card-service-equal h-100  p-0">
                              <div class="header_card bg-header-card-pink">
                                ...
                                <div class="header_icon bg-header-card-pink">
                                  <img src="{{ asset('public/assets/services/Group96.png') }}">
                                </div>
                                </div>
...
<path d="M91.9989 44.1597V47.8426C90.3311 49.8148 88.7228 51.8426 86.9757 53.7427C85.3894 55.4654 84.7563 57.306 85.4022 59.6142C85.8743 61.3016 86.2656 63.031 86.4771 64.7672C86.9439 68.5838 85.6787 70.6771 82.0831 72.0991C80.5187 72.7177 78.8795 73.1611 77.2554 73.6151C75.0648 74.2276 73.7157 75.5963 73.0744 77.7684C72.5343 79.5978 71.9829 81.4408 71.2237 83.186C70.0008 85.9962 68.0005 87.0823 64.945 86.6501C63.1227 86.3839 61.3196 86.0005 59.5471 85.5024C57.2099 84.8561 55.4234 85.5776 53.6868 87.156C51.7757 88.8937 49.6493 90.3969 47.6173 92.0023H44.3813C42.2791 90.2436 40.1512 88.5164 38.0844 86.717C36.5858 85.4107 34.9768 84.8906 32.9834 85.3581C30.8184 85.8654 28.6271 86.3352 26.4199 86.578C23.5653 86.8959 21.5099 85.5678 20.3579 82.9703C19.8292 81.7858 19.3125 80.5584 19.0738 79.2972C18.36 75.564 16.2887 73.3182 12.4687 72.6215C11.202 72.3907 9.96542 71.8623 8.78325 71.3219C6.15755 70.1194 5.06149 68.2817 5.40443 65.4466C5.