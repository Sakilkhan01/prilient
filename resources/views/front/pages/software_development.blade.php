...
@section('title', "Software Development Services | Prilient Technologies ")
...
<div class="container pt-5">
      ...
      <div class="col-lg-12 text-center py-5">
          <div class="common-heading  ">
            <h2>Full-cycle software development service that helps to boost your business efficiency </h2>
            <p>Software development is a process to design complicated software and applications that streamline your business operations and automate repetitive tasks. Software development help to increase security, improve productivity, and work efficiency. Businesses can hire software developers to build software as per their needs.</p>
            <p>We offer you a comprehensive software development service that enhances your business capabilities. We are capable of developing software with seamless API integration, modernizing the legacy system, and consolidating the app portfolio. Our trusted software developers are in solving complex problems and developing innovative, creative, and custom software that can completely transform your business. </p>
          </div>
      </div>
      <div class="col-lg-12 mt-4">
            <h4>Our Methodology for software development</h4>
            <p>
            To deliver a high-quality software development service, we focus on a simple methodology that you can read below!
            </p>
      </div>
      <div class="col-lg-12 mt-4">
            <h4>Understand the business requirement</h4>
            <p>
      ...
      <div class="col-lg-12 mt-4">
            <h4>Develop a High-quality software:</h4>
            <p>
      ...
      <div class="col-lg-12 text-center py-3">
          <div class="common-heading  ">
            <h2>Software Development Services Offered by us</h2>
          </div>
      </div>
      <div class="col-lg-12 mt-4">
      ...
      <div class="col-lg-12 text-center py-5">
          <div class="common-heading  ">
            ...
            <p>Maintain your software properly and upgrade them from time to time with us. Our developer provides complete support from software development to maintenance. They have enough knowledge of testing tools, various languages, and advanced techniques to maintain your existing software properly. They understand business requirements, market trends, and competition to launch a new version of your software. </p>
          </div>
      </div>
      <div class="col-lg-12">
      ...
      <div class="col-lg-12 mt-4">
            ...
            <p>
            By creating a custom application or software add-on designed specifically for your customers, you can offer them exactly what they need—and make sure they keep coming back to you over and over again. The software helps to retain your customer for a long time. </p>
      </div>
      <div class="col-lg-12 mt-4">
            <h4>Security</h4>
            <p>
            Privacy, security, and encryption are essential for B2B or B2C any type of software. Of course, your customers will trust your product more if they know they’re dealing with a company that cares about their data and has taken steps to protect it as much as possible.             </p>
      </div>
      <div class="col-lg-12 mt-4">
      ...
      <div class="col-lg-12 mt-4">
            <h4>Trusted Software Developers</h4>
            <p>
      ...
      <div class="col-lg-12 mt-4">
            <h4>Advance tools and technique</h4>
            <p>
