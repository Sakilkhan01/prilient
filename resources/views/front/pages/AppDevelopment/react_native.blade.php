            ...
            <div class="container">
                  <div class="row justify-content-center">
                        <div class="col-lg-6 col-12">
                              <h2 class="text-white mb-0">Hire an <span class="fontWt50">React Native Developer</span></h2>
                        </div>
                            ...
                            <div class="col-lg-5 col-12 mt-5">
                                       ...
                                       <div class="overly-two">
                                          <div class="d-flex align-items-center">
                                                <div style="width:40px">
                                                     <img alt="React Native Group3" src="{{ asset('public/assets/images/subcategory/Group3.png') }}"> 
                                                </div>
                                                <div class="ml-2">
                              ...
                              <div class="col-lg-5 col-12 mt-5 offset-lg-1">
                                    ...
                                    <div class="overly-two">
                                          <div class="d-flex align-items-center">
                                                <div style="width:40px">
                                                     <img alt="React Native Group4" src="{{ asset('public/assets/images/subcategory/Group4.png') }}"> 
                                                </div>
                                                <div class="ml-2">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5 col-12 mt-5">
                                    ...
                                    <div class="overly-two">
                                          <div class="d-flex align-items-center">
                                                <div style="width:40px">
                                                     <img alt="React Native Group5" src="{{ asset('public/assets/images/subcategory/Group5.png') }}"> 
                                                </div>
                                                <div class="ml-2">
                              ...
                              <div class="col-lg-5 col-12 mt-5 offset-lg-1">
                                    ...
                                    <div class="overly-two">
                                          <div class="d-flex align-items-center">
                                                <div style="width:40px">
                                                     <img alt="React Native Group6" src="{{ asset('public/assets/images/subcategory/Group6.png') }}"> 
                                                </div>
                                                <div class="ml-2">
