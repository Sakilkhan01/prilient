            ...
            <div class="row">
                <div class="col-lg-7 col-12 align-items-center d-flex text-lg-left text-center">
                  ...
                  <div class="col-lg-5 col-12 mt-4">
                        <img alt="iOS App" src="{{ asset('public/assets/images/subcategory/Group13.png') }}">
                </div>
            </div>
         </div>
      </div>
...
<section class="service-content-body">
    <div class="container pb-5">
      ...
      <div class="col-lg-5 col-12 text-center mt-5">
            <img alt="Mobile App" style="max-width:75%" src="{{ asset('public/assets/images/subcategory/Group7.png') }}">
      </div>
      <div class="col-lg-7 col-12 mt-5 d-flex align-items-center">
          <div class="comman-service-heading">
            <h2><span class="textRed fontWt50">Android App</span><span class="textPrim fontWt50"> Development</span></h2>
            ...
            <div class="container">
                  <div class="row justify-content-center">
                        <div class="col-lg-6 col-12">
                              <h2 class="text-white mb-0">Hire an <span class="fontWt50">Android Developer</span></h2>
                        </div>
                            ...
                            <div class="col-lg-5 col-12 mt-5">
                                       ...
                                       <div class="overly-two">
                                          <div class="d-flex align-items-center">
                                                <div style="width:40px">
                                                     <img alt="Group3" src="{{ asset('public/assets/images/subcategory/Group3.png') }}"> 
                                                </div>
                                                <div class="ml-2">
                              ...
                              <div class="col-lg-5 col-12 mt-5 offset-lg-1">
                                    ...
                                    <div class="overly-two">
                                          <div class="d-flex align-items-center">
                                                <div style="width:40px">
                                                     <img alt="Group4" src="{{ asset('public/assets/images/subcategory/Group4.png') }}"> 
                                                </div>
                                                <div class="ml-2">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5 col-12 mt-5">
                                    ...
                                    <div class="overly-two">
                                          <div class="d-flex align-items-center">
                                                <div style="width:40px">
                                                     <img alt="Group5" src="{{ asset('public/assets/images/subcategory/Group5.png') }}"> 
                                                </div>
                                                <div class="ml-2">
                              ...
                              <div class="col-lg-5 col-12 mt-5 offset-lg-1">
                                    ...
                                    <div class="overly-two">
                                          <div class="d-flex align-items-center">
                                                <div style="width:40px">
                                                     <img alt="Group6" src="{{ asset('public/assets/images/subcategory/Group6.png') }}"> 
                                                </div>
                                                <div class="ml-2">
