         ...
         <div class="container">
            <div class="row">
                <div class="col-lg-7 col-12 align-items-center d-flex text-lg-left text-center">
                  <div>
                  <h1><span class="fontWt50 common-color-heading">iOS App Development</span>
                  <span class="fontWt40">Services</span></h1>
                  ...
                  <div class="col-lg-5 col-12 mt-4">
                        <img alt="iOS App" src="{{ asset('public/assets/images/subcategory/Group1.png') }}">
                </div>
            </div>
         </div>
      </div>
            ...
            <div class="container">
                  <div class="row justify-content-center">
                        <div class="col-lg-6 col-12">
                              <h2 class="text-white mb-0">Hire an <span class="fontWt50">IOS Developer</span></h2>
                        </div>
